...
1. Check plugin symlink: `ls -l ~/.config/opencode/plugins/core-engineering.js`
2. Check source exists: `ls ~/.config/opencode/core-engineering/core-engineering/.opencode/plugins/core-engineering.js`
3. Check OpenCode logs for errors

### Skills not found

1. Check skills symlink: `ls -l ~/.config/opencode/skills/core-engineering`
2. Verify it points to: `~/.config/opencode/core-engineering/core-engineering/skills`
