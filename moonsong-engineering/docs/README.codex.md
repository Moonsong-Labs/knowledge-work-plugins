...
```
~/.agents/skills/moonsong-engineering/ → ~/.codex/moonsong-engineering/moonsong-engineering/skills/
```
...
1. Verify the symlink: `ls -la ~/.agents/skills/moonsong-engineering`
2. Check skills exist: `ls ~/.codex/moonsong-engineering/moonsong-engineering/skills`
